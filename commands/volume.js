...
module.exports.run = async (client, message, args) => {
        ...
        if (!channel) return sendError(`You need to be in a voice channel to change volume!`, message.channel);
        ...
        let xd = new MessageEmbed()
            ...
            .setAuthor("Server Volume Manager", "https://raw.githubusercontent.com/rtgamingwdt/MelloTunes/main/assets/Music.gif")
            .setColor("BLUE")
